...
> = ({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  const { data: dataTindakLanjut } = trpc.useQuery([
    "tindak.getByIDSiswa",
    String(data.id),
  ]);
  ...
  return (
    <AdminLayout
      title="Rekapitulasi Tindak Lanjut"
      breadcrumb={
        <Breadcrumb>
          <BreadcrumbItem>
    ...
    >
      <>
        <Head>
          <title>SMABAT || Rekapitulasi Tindak Lanjut</title>
        ...
        <div className="px-5 md:px-20 py-2 pb-5">
          ...
          <div className="p-5 md:p-10 min-w-[800px] overflow-auto my-5 bg-white rounded shadow">
            <RekapitulasiPanggilan
              ref={componentRef}
              data={dataTindakLanjut?.result}
              dataSiswa={data}
            />
          </div>
          {/* </Scrollbars>} */}
