...
import { RekapTerlambatSiswa } from "../../../../../../components/Surat/RekapTerlambatSiswa";
...
export const getServerSideProps: GetServerSideProps<{
  ...
  const data = await prismaFront.siswa.findFirst({
    where: {
...
> = ({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  const { data: dataTerlambat } = trpc.useQuery([
    "terlambat.getByIDSiswa",
    String(data.id),
  ]);
  ...
  return (
    ...
    >
      <>
        <Head>
          <title>SMABAT || RekapTerlambat</title>
        ...
        <div className="px-5 md:px-20 py-2 pb-5">
          ...
          <div className="p-5 md:p-10 min-w-[800px] overflow-auto my-5 bg-white rounded shadow">
            <RekapTerlambatSiswa
              ref={componentRef}
              dataTerlambat={dataTerlambat?.result}
              siswa={data}
            />
          </div>
          {/* </Scrollbars>} */}
