...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, FormControl, FormErrorMessage, FormLabel, Heading, Input, useToast } from "@chakra-ui/react";
...
import { createPanggilSchema, CreatePanggilSchema } from "../../../../../server/schema/panggil.schema";
...
const PanggilOrangTua: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
    ...
    const { register, handleSubmit, watch, setValue, reset, formState: { errors, isSubmitting, isDirty, isValid } } = useForm<CreatePanggilSchema>({
    ...
    return (
        <AdminLayout title='Panggil Orang Tua' breadcrumb={(
            <Breadcrumb>
                <BreadcrumbItem>
            ...
            <>
                ...
                <div className="px-5 py-2">
                    ...
                    <Heading mt={'4'} size={'md'}>Input Data Panggilan</Heading>
                    ...
                    <form onSubmit={handleSubmit(handleAddPanggil)}>
                        ...
                        <div className="flex justify-end flex-row mt-3 md:mt-5 items-center gap-3 md:gap-5">
                            ...
                            <Button isLoading={isSubmitting} disabled={!isValid} type='submit' fontWeight={600}
                                color={'white'}
                                bg={'orange.400'}
                                _hover={{
                                    bg: 'orange.300',
