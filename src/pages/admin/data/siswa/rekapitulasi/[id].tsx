...
> = ({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  const { data: dataPelanggaranSiswa } = trpc.useQuery([
  ...
  return (
    ...
    >
      <>
        <Head>
          <title>SMABAT || Rekapitulasi Pelanggaran</title>
        ...
        <div className="px-5 md:px-20 py-2 pb-5">
          ...
          <div className="p-5 md:p-10 min-w-[800px] overflow-auto my-5 bg-white rounded shadow">
            <RekapitulasiPelanggaran
              ref={componentRef}
              data={dataPelanggaranSiswa?.result}
              siswa={data}
            />
          </div>
          {/* </Scrollbars>} */}
