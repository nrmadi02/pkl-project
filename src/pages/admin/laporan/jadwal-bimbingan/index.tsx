...
const LaporanJadwalBimbingan: NextPage = () => {
  ...
  return (
    <AdminLayout
      title="Laporan Jadwal Bimbingan"
      breadcrumb={
        <Breadcrumb>
          <BreadcrumbItem>
    ...
    >
      <>
        <Head>
          <title>SMABAT || Laporan Jadwal Bimbingan</title>
        ...
        >
          ...
          <ModalContent className="!max-w-[1000px] relative !max-h-[80vh] overflow-auto">
            <ModalHeader>Print data</ModalHeader>
            <ModalCloseButton />
            <ModalBody className="max-w-[1000px] !max-h-[80vh] overflow-auto !pb-5">
...
export default LaporanJadwalBimbingan;
