  ...
  return (
    <>
      <Flex className="min-h-screen relative">
        ...
        <div className={`flex-initial bg-[#f8f8f8] overflow-hidden w-full transition-all ${isShow && 'ml-[300px]'}`}>
          <div className={`bg-[#f8f8f8] bg-opacity-20 backdrop-blur-lg drop-shadow-lg z-[50] fixed top-0 ${isShow ? 'left-[300px]' : 'left-0'} right-0`}>
            <div className="w-full flex gap-y-[10px] flex-col md:flex-row py-[20px] px-[20px] md:justify-between md:items-center">
              ...
              {data?.user?.name && (
                <div className={`bg-white ${isShow ? 'pl-[100px]' : 'pl-[20px]'} flex items-center justify-between md:justify-end flex-row gap-x-[20px] shadow-sm rounded-[20px] px-[20px] py-[10px] `}>
          ...
          <div className="flex bg-[#f8f8f8] mt-[185px] md:mt-[120px] flex-col">
