      ...
      <div className="font-surat p-10" ref={ref}>
        <div className="flex justify-center flex-row gap-3">
          ...
          <div className="text-center tracking-wide">
            ...
            <p className="text-[12px]">
              Jalan A. Yani Km. 33,3 Nusa Indah Kec. Bati-Bati Kab. Tanah Laut
              70852
            </p>
            <p className="text-[12px]">
              Telp. /Fax (0512) 26048, Email:{" "}
              <a className="text-blue-500 underline" href="#">
                sman1bati,bati@gmail.com
              </a>
            </p>
            <p className="text-[12px]">
              <a className="text-blue-500 underline" href="#">
                www.sman1batibati.sch.id
              </a>
            </p>
          </div>
          <div>
        ...
        <div className="mt-5">
          ...
          <div className="mt-5">
            <p>Dengan hormat,</p>
            <p>
              Sehubung dengan adanya permasalahan yang harus di selesaikan maka
              bersama ini kami mengundang Bapak/Ibu Orang Tua dan siswa yang
              bernama {props.data?.siswa.nama} kelas {props.data?.siswa.kelas}{" "}
              untuk datang ke sekolah pada :
            </p>
          </div>
          <table className="table mt-3">
            <tbody>
              <tr>
                <td width={130} className="align-top">
                  Hari/Tanggal
                </td>
                <td width={30} className="align-top">
                  :
                ...
                <td>
                  {moment(props.data?.tanggal).format("dddd, DD MMMM YYYY")}
                </td>
              </tr>
              <tr>
                <td width={130} className="align-top">
          ...
          <div className="mt-5">
            <p>
              Mengingat pentingnya hal tersebut maka kami mengharapkan sekali
              kehadiran Bapak/Ibu untuk datang tepat pada waktu yang telah
              ditentukan.
            </p>
            <p>
